...
export const ThemeToggle: React.FC<ThemeToggleProps> = ({
            ...
            <button
              ...
              className={`flex items-center justify-center gap-1.5 py-2.5 px-2 border-[2px] font-mono text-xs uppercase font-extrabold transition-all cursor-pointer select-none active:translate-y-0.5 ${
                isSelected
                  ...
                  : 'bg-white dark:bg-[#1a1a1a] text-[#4b4731] dark:text-[#c2bead] border-[#111111]/40 dark:border-white/30 hover:border-[#111111] dark:hover:border-white hover:bg-neutral-100 dark:hover:bg-[#252525]'
              }`}
            >
  ...
  return (
    <div className={`relative inline-block text-left ${className}`} ref={dropdownRef}>
      ...
      {isOpen && (
        <div
          className="absolute right-0 mt-1.5 w-44 bg-white dark:bg-[#161616] border-[2px] border-[#111111] dark:border-white/50 shadow-[3px_3px_0px_#111111] dark:shadow-[3px_3px_0px_#deb04a] z-50 py-1 font-mono text-xs uppercase select-none animate-in fade-in zoom-in-95 duration-100"
          role="menu"
