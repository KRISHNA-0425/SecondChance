    ...
    >
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b-[2.5px] border-[#111111] pb-4">
          <div>
            <div className="inline-block bg-[#111111] text-[#ffe600] px-3 py-1 font-mono text-xs uppercase font-extrabold mb-2">
        ...
        {/* Bento Grid of Brutalist Statistics */}
          ...
          {FINDINGS_DATA.map((finding) => {
            ...
            return (
              <div
                ...
                className={`${finding.bgClass} ${finding.colSpan || ''} border-[2.5px] border-[#111111] p-6 shadow-[6px_6px_0px_#111111] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[3px_3px_0px_#111111] transition-all cursor-pointer flex flex-col justify-between group`}
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="p-1 border border-[#111111] bg-white text-[#111111] shadow-[2px_2px_0px_#111111]">
      ...
      {/* Detail Modal for Selected Finding */}
      {selectedFinding && (
        <div className="fixed inset-0 z-50 bg-[#111111]/70 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white border-[3px] border-[#111111] max-w-2xl w-full p-6 sm:p-8 shadow-[8px_8px_0px_#ffe600] relative max-h-[90vh] overflow-y-auto">
            <button
            ...
            <div className="space-y-4">
              <div className="inline-block bg-[#111111] text-[#ffe600] px-2.5 py-0.5 font-mono text-xs font-bold uppercase">
                DETAILED EMPIRICAL DOSSIER // {selectedFinding.tag}
              </div>

              <div className="flex items-baseline gap-4">
                <span className="font-['Space_Grotesk'] text-5xl font-extrabold text-[#b02f00]">
              ...
              {selectedFinding.details && (
                <div className="space-y-3 pt-3 border-t-[2.5px] border-[#111111]">
                  <div className="p-3 bg-[#f6f3f2] border-[2px] border-[#111111]">
                    <div className="font-mono text-xs uppercase font-bold text-[#b02f00]">
                  ...
                  <div className="p-3 bg-[#dbe1ff] border-[2px] border-[#111111]">
                    <div className="font-mono text-xs uppercase font-bold text-[#0053db]">
              ...
              <div className="pt-2">
                <button
                  onClick={() => setSelectedFinding(null)}
                  className="w-full bg-[#111111] text-white py-3 font-mono text-xs uppercase font-bold tracking-wider hover:bg-[#ffe600] hover:text-[#111111] border-[2px] border-[#111111] transition-colors cursor-pointer"
                >
                  Close Dossier
                </button>
              </div>
