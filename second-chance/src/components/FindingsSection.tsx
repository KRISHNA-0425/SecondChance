    ...
    >
      ...
      <AnimatePresence>
        {selectedFinding && (
          ...
          >
            <motion.div
              className="bg-white border-[3px] border-[#111111] max-w-2xl w-full p-6 sm:p-8 shadow-[8px_8px_0px_#ffe600] relative max-h-[90vh] overflow-y-auto"
              ...
              <div className="space-y-4">
                ...
                {selectedFinding.details && (
                  <div className="space-y-3 pt-3 border-t-[2.5px] border-[#111111]">
                    ...
                    <motion.div
                      className="p-3 bg-[#ffe600] border-[2px] border-[#111111]"
                      initial={{ opacity: 0, x: -20 }}
                      animate={{ opacity: 1, x: 0 }}
                    ...
                    <motion.div
                      className="p-3 bg-[#dbe1ff] border-[2px] border-[#111111]"
                      initial={{ opacity: 0, x: -20 }}
                      animate={{ opacity: 1, x: 0 }}
