    ...
    <section className="w-full bg-[#111111] text-white py-12 px-4 sm:px-6 lg:px-12 border-b-[2.5px] border-[#111111]">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2" staggerDelay={0.15}>
          ...
          <StaggerItem>
            <motion.div
              className="bg-white text-[#111111] border-[2.5px] border-white p-6 shadow-[5px_5px_0px_#ffe600] flex flex-col justify-between space-y-4 h-full"
              whileHover={{
                translateY: -4,
          ...
          <StaggerItem>
            <motion.div
              className="bg-[#ffe600] text-[#111111] border-[2.5px] border-white p-6 shadow-[5px_5px_0px_#ffffff] flex flex-col justify-between space-y-4 h-full"
              whileHover={{
                translateY: -4,
          ...
          <StaggerItem>
            <motion.div
              className="bg-white text-[#111111] border-[2.5px] border-white p-6 shadow-[5px_5px_0px_#ff5722] flex flex-col justify-between space-y-4 h-full"
              whileHover={{
                translateY: -4,
            ...
            >
              <div className="mt-6 bg-[#fcf9f8] text-[#111111] border-[3px] border-[#ffe600] p-6 shadow-[6px_6px_0px_#ffe600]">
                <div className="flex items-center justify-between border-b-[2px] border-[#111111] pb-3 mb-4">
                  ...
                  <motion.span
                    className="font-mono text-xs bg-[#111111] text-[#ffe600] px-2 py-0.5 font-bold uppercase"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
                  ...
                  <StaggerContainer className="lg:col-span-6 grid grid-cols-3 gap-3" staggerDelay={0.1}>
                    ...
                    <StaggerItem>
                      <motion.div
                        className="bg-[#ffe600] border-[2px] border-[#111111] p-3 text-center shadow-[3px_3px_0px_#111111]"
                        whileHover={{ translateY: -2, boxShadow: '5px 5px 0px #111111' }}
                      >
                    ...
                    <StaggerItem>
                      <motion.div
                        className="bg-[#dbe1ff] border-[2px] border-[#111111] p-3 text-center shadow-[3px_3px_0px_#111111]"
                        whileHover={{ translateY: -2, boxShadow: '5px 5px 0px #111111' }}
                      >
