...
export const HeroSection: React.FC<HeroSectionProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <div className="w-full bg-[#111111] text-[#deb04a] border-b-[2.5px] border-[#111111] py-2 px-4 overflow-hidden">
        <div className="max-w-7xl mx-auto flex items-center justify-between text-xs font-mono uppercase font-bold tracking-widest">
          <div className="flex items-center gap-3">
            <span className="w-2.5 h-2.5 bg-[#c05a3e] rounded-full inline-block animate-ping"></span>
            <span className="text-[#deb04a]">
          ...
          <div className="hidden md:flex items-center gap-6 text-xs">
            ...
            <span className="bg-[#deb04a] text-[#111111] px-2 py-0.5 border border-[#111111] font-extrabold">
              DOSSIER PSC-2025
            </span>
          </div>
        </div>
          ...
          <div className="lg:col-span-7 flex flex-col space-y-6">
            ...
            <AnimatedSection direction="left" delay={0.1} duration={0.6}>
              <div className="inline-flex flex-wrap items-center gap-2">
                <span className="bg-[#c05a3e] text-white font-mono text-[11px] sm:text-xs uppercase px-3 py-1 font-extrabold border-[2px] border-[#111111] shadow-[2px_2px_0px_#111111]">
                  DIRECT INTERVENTION
                </span>
                <span className="bg-[#111111] text-[#deb04a] font-mono text-[11px] sm:text-xs uppercase px-3 py-1 font-extrabold">
            ...
            <div className="space-y-1">
              ...
              <AnimatedSection delay={0.5} direction="up" duration={0.6}>
                <motion.span
                  className="inline-block bg-[#deb04a] text-[#111111] px-3 sm:px-4 py-1 border-[2.5px] border-[#111111] shadow-[4px_4px_0px_#111111] -rotate-1 mt-2 font-['Space_Grotesk'] text-4xl sm:text-6xl lg:text-[68px] uppercase tracking-tighter leading-none font-bold"
                  whileHover={{
                    rotate: 1,
                    scale: 1.02,
            ...
            <AnimatedSection delay={0.6} duration={0.7}>
              <p className="font-['Inter'] text-base sm:text-lg text-[#1c1b1b] leading-relaxed max-w-2xl">
                Conceptualised by{' '}
                <strong className="underline decoration-[#913b28] decoration-2 font-bold">
            ...
            <AnimatedSection delay={0.8} direction="up" duration={0.7}>
              <div className="p-5 bg-[#f6f3f2] border-[2.5px] border-[#111111] shadow-[4px_4px_0px_#111111] relative mt-2">
                ...
                <div className="mt-3 flex items-center gap-2 font-mono text-xs text-[#913b28] font-bold uppercase">
                  <ShieldCheck className="w-4 h-4 text-[#913b28]" />
            ...
            <AnimatedSection delay={1.0} direction="up" duration={0.5}>
              <div className="flex flex-wrap items-center gap-4 pt-2">
                <motion.button
                  ...
                  className="bg-[#deb04a] text-[#111111] border-[2.5px] border-[#111111] px-6 py-3.5 font-mono text-xs sm:text-sm uppercase tracking-wider font-extrabold shadow-[4px_4px_0px_#111111] hover:bg-[#c05a3e] hover:text-white active:translate-x-1 active:translate-y-1 active:shadow-none transition-all inline-flex items-center gap-2 cursor-pointer"
          ...
          <div className="lg:col-span-5 flex flex-col items-center">
            <AnimatedSection direction="right" delay={0.3} duration={0.8}>
              <div className="w-full relative">
                ...
                <motion.div
                  className="absolute -top-4 -right-2 z-10 bg-[#c05a3e] text-white px-3 py-1 border-[2.5px] border-[#111111] font-mono text-xs uppercase font-extrabold shadow-[3px_3px_0px_#111111] rotate-3 select-none"
                  animate={{
                    y: [0, -6, 0],
                    rotate: [3, 5, 3],
                  }}
                ...
                >
                  <div className="bg-[#111111] px-3 py-1.5 flex items-center justify-between text-white font-mono text-xs uppercase font-bold">
                    <span className="flex items-center gap-1.5">
                      <motion.span
                        className="w-2 h-2 rounded-full bg-[#c05a3e]"
                ...
                <motion.div
                  className="mt-4 p-3.5 bg-[#e8edf3] border-[2px] border-[#111111] shadow-[3px_3px_0px_#111111] flex items-center gap-3"
                  whileHover={{
                    translateY: -2,
                ...
                >
                  <Gavel className="w-6 h-6 text-[#3f5670] shrink-0" />
